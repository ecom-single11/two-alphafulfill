...
const tables = [
    ...
    {
        name: 'products_promoReel_col',
        sql: `
            ALTER TABLE \`products\`
            ADD COLUMN IF NOT EXISTS \`promoReel\` VARCHAR(500) DEFAULT NULL
            AFTER \`promoImage\`;
        `
    },
    ...
    // PRODUCTS: extra Sanfe-style fields
    {
        name: 'products_extra_cols',
        sql: `
            ALTER TABLE \`products\`
            ADD COLUMN IF NOT EXISTS \`shortDescription\` VARCHAR(500) DEFAULT NULL AFTER \`description\`,
            ADD COLUMN IF NOT EXISTS \`resultTag\`        VARCHAR(100) DEFAULT NULL AFTER \`shortDescription\`,
            ADD COLUMN IF NOT EXISTS \`badge\`            VARCHAR(100) DEFAULT NULL AFTER \`resultTag\`,
            ADD COLUMN IF NOT EXISTS \`benefits\`         JSON         DEFAULT NULL AFTER \`badge\`,
            ADD COLUMN IF NOT EXISTS \`whyLoveIt\`        JSON         DEFAULT NULL AFTER \`benefits\`,
            ADD COLUMN IF NOT EXISTS \`keyIngredients\`   JSON         DEFAULT NULL AFTER \`whyLoveIt\`,
            ADD COLUMN IF NOT EXISTS \`howToUse\`         LONGTEXT     DEFAULT NULL AFTER \`keyIngredients\`,
            ADD COLUMN IF NOT EXISTS \`additionalDetails\` LONGTEXT    DEFAULT NULL AFTER \`howToUse\`,
            ADD COLUMN IF NOT EXISTS \`consumerCareDetails\` LONGTEXT  DEFAULT NULL AFTER \`additionalDetails\`,
            ADD COLUMN IF NOT EXISTS \`faqs\`             JSON         DEFAULT NULL AFTER \`consumerCareDetails\`,
            ADD COLUMN IF NOT EXISTS \`promoImage\`       VARCHAR(500) DEFAULT NULL AFTER \`faqs\`,
            ADD COLUMN IF NOT EXISTS \`galleryMedia\`     JSON         DEFAULT NULL AFTER \`promoImage\`;
        `
    },
